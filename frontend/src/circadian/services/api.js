...
export const getDiaryBlocks = async (pageNum, searchText="") => {
    const response = await axiosInstance.get(BASE_API_PATH + `diary/blocks/?page=${pageNum}&search-text=${searchText}`);
    return response;
};
